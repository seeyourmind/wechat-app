...
Page({
  ...
  submitToService: function(){
    var maintainerid = this.data.array[this.data.index];
    console.log('需要提交到数据库的数据有', machines, maintainerid, crud)

    if (maintainerid == '请选择' || !(/^\d+$/.test(maintainerid))) {
      wx.showToast({
      ...
      wx.request({
        ...
        success: function (res) {
          console.log('assign for maintainer success res-->',res)
