...
Page({
  ...
  onLoad: function (options) {
    ...
    that.getMaintainLogs(options.id,function(info){
      that.setData({
        maintainInfo: info
      })
    });
  ...
  onPullDownRefresh() {
    ...
    this.getMaintainLogs(userid, function (info) {
      that.setData({
        maintainInfo: info
      });
      wx.showToast({
  ...
  onReachBottom: function (e) {
    timeflag += 1;
    var that = this;
    var temparay = that.data.maintainInfo;
