...
function wxSearchInput(e, that, callBack){
  console.log('调用了wxSearch.js中的wxSearchInput')
    ...
    console.log('调用了wxSearch.js中的wxSearchInput将wxSearchData.value设置为', that.data.wxSearchData.value)
}
...
function wxSearchBlur(e, that, callBack) {
  console.log('调用了wxSearch.js中的wxSearchBlur')
    var temData = that.data.wxSearchData;
    temData.value = e.detail.value;
    that.setData({
        wxSearchData: temData
    });
    console.log('调用了wxSearch.js中的wxSearchBlur将wxSearchData.value设置为', that.data.wxSearchData.value)
    if (typeof (callBack) == "function") {
        callBack();
    }
}
...
function wxSearchKeyTap(e, that, callBack) {
    console.log('调用了wxSearch.js中的wxSearchKeyTap')
    //回调
    var temData = that.data.wxSearchData;
    ...
    console.log('调用了wxSearch.js中的wxSearchKeyTap将wxSearchData.value设置为', that.data.wxSearchData.value)
    if (typeof (callBack) == "function") {
        callBack();
    }
}
